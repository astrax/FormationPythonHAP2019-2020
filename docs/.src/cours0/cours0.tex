...
% inline figure
\centerline{\includegraphics[width=0.6\linewidth]{images/python_easy.png}}
...
\begin{figure}[!ht]  % 
  \centerline{\includegraphics[width=0.7\linewidth]{images/AnacondaNavigator.png}}
  \caption{
...
\begin{figure}[!ht]  % 
  \centerline{\includegraphics[width=0.7\linewidth]{images/pydroid3_1.png}}
  \caption{
...
\begin{figure}[!ht]  % 
  \centerline{\includegraphics[width=0.7\linewidth]{images/pydroid3_2.png}}
  \caption{
