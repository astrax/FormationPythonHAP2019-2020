...
\begin{itemize}
\item Ecrivez la fonction \texttt{EqSecondDegree(a,b,c)} qui \textbf{renvoie} les solutions de l'équation $a x^2 + bx + c = 0$.

\item Enregistrez la fonction \texttt{EqSecondDegree(a,b,c)} dans un script Python \texttt{racines.py} puis l'exécuter dans la cellule de code suivante:
\end{itemize}
